/**
 * Logo Nova — marque annulaire (étoile).
 * 
...
export function NovaLogo({ size = 96, faceColor }: { size?: number; faceColor?: string }) {
  ...
  return (
    <Svg width={size} height={size} viewBox="-50 -50 100 100">
      <Defs>
        <LinearGradient id="novaGold" x1="0" y1="-1" x2="0" y2="1">
      ...
      <Circle cx={0} cy={0} r={8} fill="url(#novaGold)" />
    </Svg>
  );
}
