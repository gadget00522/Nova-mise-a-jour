...
Canal officiel Telegram : https://t.me/kalyxntw`,
  ...
  return (
    <LegalPage
      ...
      intro="Lisez attentivement ces conditions avant d’utiliser Kalyx Wallet. Elles définissent le cadre d’utilisation responsable et les spécificités du modèle non-custodial."
      meta={['Révision : 5 juillet 2026', 'Version bêta', 'Modèle non-custodial']}
      sections={sections}
      contactTitle="Besoin d’éclaircissements ?"
      contactText="Écrivez-nous pour toute question relative aux conditions, juridique ou technique."
    />
  );
}
