...
export function Download({ t }: { t: Dict }) {
  return (
    <section id="telecharger" className="scroll-mt-16 bg-ink px-5 py-20 sm:px-8 sm:py-24 lg:py-36">
      <div className="mx-auto max-w-page text-center">
        ...
        <Reveal as="h2" className="mx-auto max-w-3xl font-display text-[2.25rem] font-light leading-[1.05] tracking-[-0.02em] text-paper sm:text-6xl">
