...
const fr = {
  ...
  ai: {
    kicker: 'Le copilote IA',
    title: 'Une IA qui vous explique,',
    titleEm: 'sans jamais vous espionner.',
    lead: 'Kalyx n’a pas de serveur d’IA et ne détient aucune clé pour vous. Le copilote est optionnel : vous branchez votre propre fournisseur, et vous seul payez ce que vous consommez.',
    items: [
      { value: '9', label: 'fournisseurs, ou une URL à vous', note: 'OpenAI, Anthropic (Claude), Gemini, DeepSeek, Groq, OpenRouter, Together, Hugging Face — ou tout point d’accès compatible OpenAI, à votre adresse.' },
      { value: '0', label: 'serveur Kalyx qui voit votre clé', note: 'Votre clé API est chiffrée sur votre téléphone et part directement chez le fournisseur choisi. Kalyx ne la voit jamais, ne la stocke jamais.' },
      { value: '0 €', label: 'de marge prise par Kalyx', note: 'Vous payez votre fournisseur au tarif qu’il affiche — souvent avec un palier gratuit. Kalyx ne prélève rien sur l’IA.' },
      { value: 'Off', label: 'par défaut, jusqu’à votre clé', note: 'Le copilote reste désactivé tant que vous n’avez pas collé de clé API. Aucune donnée ne part sans ce geste.' },
    ],
    p1a: 'Avant de signer, demandez « qu’est-ce que ce contrat va faire ? »',
    p1em: ' le copilote lit la simulation',
    p1b: ' et répond en une phrase, dans votre langue — le même principe que chaque signature déjà traduite en clair.',
    p2: 'Changez de fournisseur ou de modèle à tout moment, ou coupez tout en un geste depuis les réglages. BYOK veut dire : votre clé, vos règles, votre budget.',
  },
  fees: {
